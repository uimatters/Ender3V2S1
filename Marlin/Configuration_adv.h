...
#define MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED 5 // BeltEnder setting
 ...
 */
#define PREHEAT_TIME_HOTEND_MS 10000  // BeltEnder setting
...
#define BABYSTEPPING  // Ender Configs
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  1       // (steps or mm) Steps or millimeter distance for each Z babystep  // Ender Configs
...
#define FWRETRACT  // MRiscoC Enabled support for firmware based retract
  ...
  #define RETRACT_FEEDRATE             45   // (mm/s) Default feedrate for retracting  // MRiscoC Bowden
